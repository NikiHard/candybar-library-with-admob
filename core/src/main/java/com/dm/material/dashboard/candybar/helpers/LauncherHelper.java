...
public class LauncherHelper {
    ...
    private static final int MICROSOFT = 28;
        ...
        switch (id) {
            ...
            case LAWNCHAIR:
                try {
                    ...
                    openhelper(context, "ch.deletescape.lawnchair.plah", launcherName, "ch.deletescape.lawnchair.settings.ui.SettingsActivity");
            ...
            case MICROSOFT:
                //Todo: fix direct apply for flick launcher
                try {
                    final Intent microsoft = context.getPackageManager().getLaunchIntentForPackage(
                            "com.microsoft.launcher");
                    openhelper(context, launcherPackage, launcherName,"com.microsoft.launcher.Launcher");
    ...
    private static void openhelper(Context context, String packageName, String launcherName, String cls) {
        ...
        new MaterialDialog.Builder(context)
                ...
                .content(context.getResources().getString(R.string.apply_manual,
                        ...
                        context.getResources().getString(R.string.apply_manual_evie,
                                context.getResources().getString(R.string.app_name)))
                .positiveText(context.getResources().getString(R.string.helper_go))
                .onPositive((dialog, which) -> {
                    try {
