...
public abstract class CandyBarApplication extends Application implements ApplicationCallback {
    ...
    public static class Configuration {
        ...
        private boolean mIsDashboardPusheEnabled = true;
        ...
        public Configuration setDashboardPusheEnabled(boolean dashboardPusheEnabled) {
            mIsDashboardPusheEnabled = dashboardPusheEnabled;
            return this;
        }
        ...
        public boolean isDashboardPusheEnabled() {
            return mIsDashboardPusheEnabled;
        }
